        ...
        <div className="mt-6 flex flex-wrap items-center gap-3">
          ...
          {secondaryCtaText && secondaryCtaHref ? (
            <a
              ...
              className="inline-flex items-center justify-center rounded-full border border-slate-700/80 bg-slate-950/30 px-5 py-2.5 text-[11px] font-bold uppercase tracking-[0.18em] text-slate-200 transition hover:border-cyan-400/70 hover:text-cyan-200 active:scale-95"
            >
              {secondaryCtaText}
            </a>
          ) : null}
