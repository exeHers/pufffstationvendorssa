  ...
  return (
    <div className="flex h-screen w-full flex-col items-center justify-center bg-slate-950 text-center px-4">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center z-10">
        <h2 className="mb-2 text-2xl font-bold uppercase tracking-widest text-cyan-300">
          Signal Lost
        </h2>
        ...
        <Link 
          href="/"
          className="rounded-full bg-cyan-600 px-8 py-3 text-[10px] font-black uppercase tracking-[0.2em] text-white shadow-lg shadow-cyan-500/20 transition hover:bg-cyan-500 hover:scale-105"
        >
          Return to Base
        </Link>
      </div>
